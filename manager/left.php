        ...
        <div class="sidebar-content">
            <ul class="sidebar-list">
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="list.php?show=members"><i class="icon-font">&#xe008;</i>会员管理</a></li>
						<li><a href="list.php?show=redeem"><i class="icon-font">&#xe008;</i>卡密管理</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="stat.php"><i class="icon-font">&#xe037;</i>数据信息</a></li>
                    </ul>
                </li>
            </ul>
        </div>
